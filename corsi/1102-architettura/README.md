...
- Anno/semestre: 1° anno, primo semestre
- CFU: 9 CFU  
- Stato: Completato [✅]
...
- `universita/notes-onenote/`: directory legacy da preservare; contiene un
  `.gitkeep` in collisione con la destinazione gia esistente.
